...
type mockConstructorTestingTNewS3UserServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewS3UserServiceServer(t mockConstructorTestingTNewS3UserServiceServer) *S3UserServiceServer {
