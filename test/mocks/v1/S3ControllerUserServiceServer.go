...
type NewS3ControllerUserServiceServerT interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewS3ControllerUserServiceServer(t NewS3ControllerUserServiceServerT) *S3ControllerUserServiceServer {
