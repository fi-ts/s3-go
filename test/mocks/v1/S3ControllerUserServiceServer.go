...
type mockConstructorTestingTNewS3ControllerUserServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewS3ControllerUserServiceServer(t mockConstructorTestingTNewS3ControllerUserServiceServer) *S3ControllerUserServiceServer {
