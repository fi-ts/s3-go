...
type mockConstructorTestingTNewUnsafeS3UserServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewUnsafeS3UserServiceServer(t mockConstructorTestingTNewUnsafeS3UserServiceServer) *UnsafeS3UserServiceServer {
