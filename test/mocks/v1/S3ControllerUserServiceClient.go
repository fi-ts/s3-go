...
type mockConstructorTestingTNewS3ControllerUserServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewS3ControllerUserServiceClient(t mockConstructorTestingTNewS3ControllerUserServiceClient) *S3ControllerUserServiceClient {
