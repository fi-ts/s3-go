...
type NewS3ControllerUserServiceClientT interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewS3ControllerUserServiceClient(t NewS3ControllerUserServiceClientT) *S3ControllerUserServiceClient {
