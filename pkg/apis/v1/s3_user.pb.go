...
var file_metalstack_io_s3_api_v1_s3_user_proto_goTypes = []any{
...
func file_metalstack_io_s3_api_v1_s3_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_metalstack_io_s3_api_v1_s3_user_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*S3User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_metalstack_io_s3_api_v1_s3_user_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_metalstack_io_s3_api_v1_s3_user_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_metalstack_io_s3_api_v1_s3_user_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_metalstack_io_s3_api_v1_s3_user_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_metalstack_io_s3_api_v1_s3_user_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_metalstack_io_s3_api_v1_s3_user_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_metalstack_io_s3_api_v1_s3_user_proto_msgTypes[7].Exporter = func(v any, i int) any {
